...
First, find a sample. I recommend a note that either is substantially sustained or can be seamlessly looped. The sound I used was very simple, just to see if this idea was going to work (it worked). I'm sure this would be even cooler if a more dynamic sound was used.
Take the sample and hit **Shift + ALL** and load it into every slot on a fresh program. Continue holding Shift and smash that **CHROM.** button.   
...
<iframe width="100%" height="166" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/649418921&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true"></iframe>


Messing with the PITCH comes out pretty tight too  


![Pitch-photo](/assets/mpc5.BMP)


Check it out:

<iframe width="100%" height="166" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/649419563&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true"></iframe>
...
[**Download for the program I setup above, HERE**](/assets/tut.PGM)  
