...
This morning I sampled my Yamaha PSS-460 to create some quick access MPC instrument programs. Each preset was sampled five times (five octaves of "C") for a total of 135 samples for 27 instrument programs. 
These work with JJOS2xl and possibly other JJOS variants.  
...
[**A zip of all the files is available for download HERE**](/assets/PSS-Stabs.zip)  